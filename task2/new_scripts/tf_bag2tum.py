...
class Converter:
    def __init__(self, bag_path, txt_path, topic_name, body_frame, camera_frame, map_frame):
    ...
    def callback(self, msgs):
        for msg in msgs.transforms:
            ...
            if msg.header.frame_id == self.map_frame:
                ...
                # Modify this line if chaning to the different SLAM algorithm
                self.file.write(f"{time} {pose.pose.position.x} {pose.pose.position.z} {pose.pose.position.y} {msg_quaternion[0]} {msg_quaternion[1]} {msg_quaternion[2]} {msg_quaternion[3]}\n")
